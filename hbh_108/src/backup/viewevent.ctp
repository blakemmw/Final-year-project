...
<div class="content">
    <div class="navagation">
        ...
        <ul>
            <li id="nav-item">
                <a href="../mydashboard" ><i id="nav-icon" class="fas fa-clipboard-list"></i>listings</a></li>
    ...
    <div class="main">
        <div class="header">
            <a href="../mydashboard"><i id="back-button" class="fas fa-chevron-left"></i></a>
            ...
            <div class="desc-area">
                ...
                <div class="event-desc-main">
                    ...
                    <?php foreach ($event->tags as $tags): ?>
                        ...
                        <p class="desc-component"><?= h($tags->tag_name) ?></p>
                        <p><?= h($tags->tag_name) ?> </p>
        ...
        <div class="create-form-container" id="create-form-container">
            ...
            <?= $this->Form->create($event, ['class' => 'create-form']) ?>
                ...
                echo $this->Form->control('tags._ids',['id' => 'tags-selects'], ['options' => $tags]);
            ...
            <button class="btn-next" type="submit" id="next03-edit">next</button>
...
<script type="text/javascript">
    ...
    $('#next02').click(function(){
        ...
        $("#next03-edit").slideUp( 100 ).delay( 400 ).fadeIn( 500 );
    ...
    $('#next03-edit').click(function(){
        //hide below:
        $("#next03-edit").fadeOut(1);
