...
class AuditsController extends AppController
{
    ...
    public function add()
    {
        ...
        $events = $this->Audits->Events->find('list', ['limit' => 200]);
        $users = $this->Audits->Users->find('list', ['limit' => 200]);
        $bookings = $this->Audits->Bookings->find('list', ['limit' => 200]);
        $this->set(compact('audit', 'events', 'users', 'bookings'));
    }
