...
class EventsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $fff = $this->request->getData()['file']['name'];
            ...
            $event->file_name = $fff;
            debug($fff);exit;
            move_uploaded_file($_FILES["file"]["tmp_name"], WWW_ROOT . $filepath);
        ...
        $roomsUsers = $this->RoomsUsers->find('list', [
    ...
    public function view($id = null){
        ...
        $rooms = $this->Events->Rooms->find('list', ['limit' => 200]);
		     ...
		     //   debug($event);exit;
        $this->set(compact('event', 'dashboard','tags', 'users'));
